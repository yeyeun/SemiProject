...
public interface CourseMapper {
    ...
    @Update("UPDATE COURSE SET title=#{title},overview=#{overview},subcontentid=#{subcontentid},firstimage=#{firstimage} WHERE contentid=#{contentid}")
    void modify(@Param("contentid") String contentid, @Param("firstimage") String firstimage, @Param("subcontentid") String subcontentid, @Param("title") String title, @Param("overview") String overview);
