...
<form name="myprofile" action="${contextPath}/product/add.pro"
			method="post" enctype="multipart/form-data"> <!-- 파일이 있을경우 무조건 post방식 -->
			...
			<input type="button" class="btn btn-primary" value="저장"
				onclick="checkAddProduct()" style="margin-left: 120px;">
		</form>
	</div>
</div>
